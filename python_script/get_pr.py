    ...
    for merge in merges:
       ...
       #executar na primeira página e pegar o ultimo created_at e colocar na variavel ultima_Pagina
        ...
        for PR in json_objs['items']:
          ...
          if fechado <> '0':
             conecta.c.execute("insert into pr (owner, linguagem, user, nome_projeto, id_git, number_pr, merge, dt_criado, dt_fechado)values ('%s', '%s', '%s', '%s', '%d', '%s', '%s', '%s', '%s')"%(owner, language, user, repo, id_git, number, merge, criado, fechado))
             ...
             conecta.c.execute ("insert into pr (owner, linguagem, user, nome_projeto, id_git, number_pr, merge, dt_criado)values ('%s', '%s', '%s', '%s', '%d','%s', '%s', '%s')"%(owner, language, user, repo, id_git, number, merge, criado))
